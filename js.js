...
function getFormula(which) {
  switch(which) {
    case "leftangle":
      ...
      break;
    case "rightcathode":
      document.getElementById('formula').innerHTML="<img src='billeder/4.png' width='200'></img> <br> eller <br> <img src='billeder/5.png' width='200'></img> <br> eller <br> <img src='billeder/6.png' width='200'></img> <br> eller <br> <img src='billeder/7.png' width='200'></img> <br> eller <br> <img src='billeder/8.png' width='200'></img>";
      break;
    case "lowercathode":
